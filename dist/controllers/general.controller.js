...
var addNewPatient = exports.addNewPatient = /*#__PURE__*/function () {
  var _ref2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(req, res) {
    var _req$body, ID_Paciente, Nombre, Apellido, Genero, Fecha_Nacimiento, Direccion, Telefono, Correo_Electronico, ID_Aseguradora, pool;
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _req$body = req.body, ID_Paciente = _req$body.ID_Paciente, Nombre = _req$body.Nombre, Apellido = _req$body.Apellido, Genero = _req$body.Genero, Fecha_Nacimiento = _req$body.Fecha_Nacimiento, Direccion = _req$body.Direccion, Telefono = _req$body.Telefono, Correo_Electronico = _req$body.Correo_Electronico, ID_Aseguradora = _req$body.ID_Aseguradora;
